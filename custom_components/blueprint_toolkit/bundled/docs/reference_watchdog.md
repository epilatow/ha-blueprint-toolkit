...
- Source integration exclusion for bulk-silencing of specific config-entry
  integrations
- Path-glob exclusion for skipping whole files or dashboards
...
| Max source notifications              | Per-owner notification cap. Default 10. 0 = unlimited. The source-orphan summary is always emitted separately and is not subject to this cap.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
up after deleting the entity, an `*.yml` glob in **Exclude paths** that
matches no scanned file, a regex line that catches nothing -- shows up in a
